...
public class DotsView: UIView {
    ...
    //MARK: - Variables
    open var dotSize: CGFloat  = UIScreen.main.bounds.height * 0.012
    @IBInspectable
    var _dotSize : CGFloat = UIScreen.main.bounds.height * 0.012{
        didSet{
            dotSize = _dotSize
        }
    }
    ...
    open var translation : CGFloat = (UIScreen.main.bounds.height * 0.012) / 2
    @IBInspectable
    var _translation : CGFloat = (UIScreen.main.bounds.height * 0.012) / 2{
        didSet{
