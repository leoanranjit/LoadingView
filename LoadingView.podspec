...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
'Loading view is a interactive loading indicator that can be used with any UIView. It also contains easy customization of the loading indicator along with customization to its border, shadow and corner radius.'
                       DESC
